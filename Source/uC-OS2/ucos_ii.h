...
// Added GPM 20-Oct-2020
#define  OS_EVENT_NAME_EN      (((OS_Q_EN > 0u) && (OS_MAX_QS > 0u)) || (OS_FLAG_NAME_EN > 0u) || (OS_MEM_NAME_EN > 0u))
...
#if (OS_EVENT_NAME_EN > 0u)
_NEAR INT8U         OSEventNameGet          (OS_EVENT        *pevent,
                                       INT8U          **pname,
                                       INT8U           *perr);

_NEAR void          OSEventNameSet          (OS_EVENT        *pevent,
                                       INT8U           *pname,
                                       INT8U           *perr);
#endif

#if (OS_EVENT_MULTI_EN > 0u)
_NEAR INT16U        OSEventPendMulti        (OS_EVENT       **pevents_pend,
...
_NEAR OS_TLS_ID     OS_TLS_GetID            (INT8U               *perr);

_NEAR OS_TLS        OS_TLS_GetValue         (OS_TCB              *ptcb,
                                       OS_TLS_ID            id,
                                       INT8U               *perr);

_NEAR void          OS_TLS_Init             (INT8U               *perr);

_NEAR void          OS_TLS_SetValue         (OS_TCB              *ptcb,
                                       OS_TLS_ID            id,
                                       OS_TLS               value,
                                       INT8U               *perr);

_NEAR void          OS_TLS_SetDestruct      (OS_TLS_ID            id,
                                       OS_TLS_DESTRUCT_PTR  pdestruct,
                                       INT8U               *perr);

_NEAR void          OS_TLS_TaskCreate       (OS_TCB              *ptcb);

_NEAR void          OS_TLS_TaskDel          (OS_TCB              *ptcb);

_NEAR void          OS_TLS_TaskSw           (void);
...
_NEAR OS_FLAG_GRP  *OSFlagCreate            (OS_FLAGS         flags,
                                       INT8U           *perr);

#if OS_FLAG_DEL_EN > 0u
_NEAR OS_FLAG_GRP  *OSFlagDel               (OS_FLAG_GRP     *pgrp,
                                       INT8U            opt,
                                       INT8U           *perr);
#endif

#if (OS_FLAG_EN > 0u) && (OS_FLAG_NAME_EN > 0u)
_NEAR INT8U         OSFlagNameGet           (OS_FLAG_GRP     *pgrp,
                                       INT8U          **pname,
                                       INT8U           *perr);

_NEAR void          OSFlagNameSet           (OS_FLAG_GRP     *pgrp,
                                       INT8U           *pname,
                                       INT8U           *perr);
#endif

_NEAR OS_FLAGS      OSFlagPend              (OS_FLAG_GRP     *pgrp,
                                       OS_FLAGS         flags,
                                       INT8U            wait_type,
                                       INT32U           timeout,
                                       INT8U           *perr);

_NEAR OS_FLAGS      OSFlagPendGetFlagsRdy   (void);
_NEAR OS_FLAGS      OSFlagPost              (OS_FLAG_GRP     *pgrp,
                                       OS_FLAGS         flags,
                                       INT8U            opt,
                                       INT8U           *perr);

#if OS_FLAG_QUERY_EN > 0u
_NEAR OS_FLAGS      OSFlagQuery             (OS_FLAG_GRP     *pgrp,
                                       INT8U           *perr);
#endif
#endif
...
_NEAR void         *OSMboxAccept            (OS_EVENT        *pevent);
#endif

_NEAR OS_EVENT     *OSMboxCreate            (void            *pmsg);

#if OS_MBOX_DEL_EN > 0u
_NEAR OS_EVENT     *OSMboxDel               (OS_EVENT        *pevent,
                                       INT8U            opt,
                                       INT8U           *perr);
#endif

_NEAR void         *OSMboxPend              (OS_EVENT        *pevent,
                                       INT32U           timeout,
                                       INT8U           *perr);

#if OS_MBOX_PEND_ABORT_EN > 0u
_NEAR INT8U         OSMboxPendAbort         (OS_EVENT        *pevent,
                                       INT8U            opt,
                                       INT8U           *perr);
#endif

#if OS_MBOX_POST_EN > 0u
_NEAR INT8U         OSMboxPost              (OS_EVENT        *pevent,
                                       void            *pmsg);
#endif

#if OS_MBOX_POST_OPT_EN > 0u
_NEAR INT8U         OSMboxPostOpt           (OS_EVENT        *pevent,
                                       void            *pmsg,
                                       INT8U            opt);
#endif

#if OS_MBOX_QUERY_EN > 0u
_NEAR INT8U         OSMboxQuery             (OS_EVENT        *pevent,
...
_NEAR OS_MEM       *OSMemCreate             (void            *addr,
                                       INT32U           nblks,
                                       INT32U           blksize,
                                       INT8U           *perr);

_NEAR void         *OSMemGet                (OS_MEM          *pmem,
                                       INT8U           *perr);
#if OS_MEM_NAME_EN > 0u
_NEAR INT8U         OSMemNameGet            (OS_MEM          *pmem,
                                       INT8U          **pname,
                                       INT8U           *perr);

_NEAR void          OSMemNameSet            (OS_MEM          *pmem,
                                       INT8U           *pname,
                                       INT8U           *perr);
#endif
_NEAR INT8U         OSMemPut                (OS_MEM          *pmem,
                                       void            *pblk);

#if OS_MEM_QUERY_EN > 0u
_NEAR INT8U         OSMemQuery              (OS_MEM          *pmem,
...
_NEAR BOOLEAN       OSMutexAccept           (OS_EVENT        *pevent,
                                       INT8U           *perr);
#endif

_NEAR OS_EVENT     *OSMutexCreate           (INT8U            prio,
                                       INT8U           *perr);

#if OS_MUTEX_DEL_EN > 0u
_NEAR OS_EVENT     *OSMutexDel              (OS_EVENT        *pevent,
                                       INT8U            opt,
                                       INT8U           *perr);
#endif

_NEAR void          OSMutexPend             (OS_EVENT        *pevent,
                                       INT32U           timeout,
                                       INT8U           *perr);

_NEAR INT8U         OSMutexPost             (OS_EVENT        *pevent);

#if OS_MUTEX_QUERY_EN > 0u
_NEAR INT8U         OSMutexQuery            (OS_EVENT        *pevent,
...
_NEAR void         *OSQAccept               (OS_EVENT        *pevent,
                                       INT8U           *perr);
#endif

_NEAR OS_EVENT     *OSQCreate               (void           **start,
                                       INT16U           size);

#if OS_Q_DEL_EN > 0u
_NEAR OS_EVENT     *OSQDel                  (OS_EVENT        *pevent,
                                       INT8U            opt,
                                       INT8U           *perr);
#endif

#if OS_Q_FLUSH_EN > 0u
_NEAR INT8U         OSQFlush                (OS_EVENT        *pevent);
#endif

_NEAR void         *OSQPend                 (OS_EVENT        *pevent,
                                       INT32U           timeout,
                                       INT8U           *perr);

#if OS_Q_PEND_ABORT_EN > 0u
_NEAR INT8U         OSQPendAbort            (OS_EVENT        *pevent,
                                       INT8U            opt,
                                       INT8U           *perr);
#endif

#if OS_Q_POST_EN > 0u
_NEAR INT8U         OSQPost                 (OS_EVENT        *pevent,
                                       void            *pmsg);
#endif

#if OS_Q_POST_FRONT_EN > 0u
_NEAR INT8U         OSQPostFront            (OS_EVENT        *pevent,
                                       void            *pmsg);
#endif

#if OS_Q_POST_OPT_EN > 0u
_NEAR INT8U         OSQPostOpt              (OS_EVENT        *pevent,
                                       void            *pmsg,
                                       INT8U            opt);
#endif

#if OS_Q_QUERY_EN > 0u
_NEAR INT8U         OSQQuery                (OS_EVENT        *pevent,
                                       OS_Q_DATA       *p_q_data);
#endif
...
_NEAR INT16U        OSSemAccept             (OS_EVENT        *pevent);
#endif

_NEAR OS_EVENT     *OSSemCreate             (INT16U           cnt);

#if OS_SEM_DEL_EN > 0u
_NEAR OS_EVENT     *OSSemDel                (OS_EVENT        *pevent,
                                       INT8U            opt,
                                       INT8U           *perr);
#endif

_NEAR void          OSSemPend               (OS_EVENT        *pevent,
                                       INT32U           timeout,
                                       INT8U           *perr);

#if OS_SEM_PEND_ABORT_EN > 0u
_NEAR INT8U         OSSemPendAbort          (OS_EVENT        *pevent,
                                       INT8U            opt,
                                       INT8U           *perr);
#endif

_NEAR INT8U         OSSemPost               (OS_EVENT        *pevent);

#if OS_SEM_QUERY_EN > 0u
_NEAR INT8U         OSSemQuery              (OS_EVENT        *pevent,
                                       OS_SEM_DATA     *p_sem_data);
#endif

#if OS_SEM_SET_EN > 0u
_NEAR void          OSSemSet                (OS_EVENT        *pevent,
                                       INT16U           cnt,
                                       INT8U           *perr);
#endif
...
_NEAR INT8U         OSTaskChangePrio        (INT8U            oldprio,
                                       INT8U            newprio);
#endif

#if OS_TASK_CREATE_EN > 0u
_NEAR INT8U         OSTaskCreate            (void           (*task)(void *p_arg),
                                       void            *p_arg,
                                       OS_STK          *ptos,
                                       INT8U            prio);
#endif
...
#if OS_TASK_CREATE_EXT_EN > 0u
_NEAR INT8U         OSTaskCreateExt         (void           (*task)(void *p_arg),
                                       void            *p_arg,
                                       OS_STK          *ptos,
                                       INT8U            prio,
                                       INT16U           id,
...
#if OS_TASK_DEL_EN > 0u
_NEAR INT8U         OSTaskDel               (INT8U            prio);
_NEAR INT8U         OSTaskDelReq            (INT8U            prio);
#endif

#if OS_TASK_NAME_EN > 0u
_NEAR INT8U         OSTaskNameGet           (INT8U            prio,
                                       INT8U          **pname,
                                       INT8U           *perr);

_NEAR void          OSTaskNameSet           (INT8U            prio,
                                       INT8U           *pname,
                                       INT8U           *perr);
#endif

#if OS_TASK_SUSPEND_EN > 0u
_NEAR INT8U         OSTaskResume            (INT8U            prio);
_NEAR INT8U         OSTaskSuspend           (INT8U            prio);
#endif

#if (OS_TASK_STAT_STK_CHK_EN > 0u) && (OS_TASK_CREATE_EXT_EN > 0u)
_NEAR INT8U         OSTaskStkChk            (INT8U            prio,
                                       OS_STK_DATA     *p_stk_data);
#endif

#if OS_TASK_QUERY_EN > 0u
_NEAR INT8U         OSTaskQuery             (INT8U            prio,
                                       OS_TCB          *p_task_data);
#endif
...
#if OS_TASK_REG_TBL_SIZE > 0u
_NEAR INT32U        OSTaskRegGet            (INT8U            prio,
                                       INT8U            id,
                                       INT8U           *perr);

_NEAR INT8U         OSTaskRegGetID          (INT8U           *perr);

_NEAR void          OSTaskRegSet            (INT8U            prio,
                                       INT8U            id,
                                       INT32U           value,
                                       INT8U           *perr);
#endif
...
_NEAR void          OSTimeDly               (INT32U           ticks);

#if OS_TIME_DLY_HMSM_EN > 0u
_NEAR INT8U         OSTimeDlyHMSM           (INT8U            hours,
                                       INT8U            minutes,
                                       INT8U            seconds,
                                       INT16U           ms);
#endif
...
_NEAR INT8U         OSTimeDlyResume         (INT8U            prio);
#endif

#if OS_TIME_GET_SET_EN > 0u
_NEAR INT32U        OSTimeGet               (void);
_NEAR void          OSTimeSet               (INT32U           ticks);
#endif

_NEAR void          OSTimeTick              (void);
...
#if OS_TMR_EN > 0u
_NEAR OS_TMR      *OSTmrCreate              (INT32U           dly,
                                       INT32U           period,
                                       INT8U            opt,
...
_NEAR BOOLEAN      OSTmrDel                 (OS_TMR          *ptmr,
                                       INT8U           *perr);

#if OS_TMR_CFG_NAME_EN > 0u
_NEAR INT8U        OSTmrNameGet             (OS_TMR          *ptmr,
                                       INT8U          **pdest,
                                       INT8U           *perr);
#endif
_NEAR INT32U       OSTmrRemainGet           (OS_TMR          *ptmr,
                                       INT8U           *perr);

_NEAR INT8U        OSTmrStateGet            (OS_TMR          *ptmr,
                                       INT8U           *perr);

_NEAR BOOLEAN      OSTmrStart               (OS_TMR          *ptmr,
                                       INT8U           *perr);

_NEAR BOOLEAN      OSTmrStop                (OS_TMR          *ptmr,
                                       INT8U            opt,
                                       void            *callback_arg,
                                       INT8U           *perr);

_NEAR INT8U        OSTmrSignal              (void);
#endif
...
_NEAR void          OSInit                  (void);

_NEAR void          OSIntEnter              (void);
_NEAR void          OSIntExit               (void);

#ifdef OS_SAFETY_CRITICAL_IEC61508
_NEAR void          OSSafetyCriticalStart   (void);
#endif

#if OS_SCHED_LOCK_EN > 0u
_NEAR void          OSSchedLock             (void);
_NEAR void          OSSchedUnlock           (void);
#endif

_NEAR void          OSStart                 (void);

_NEAR void          OSStatInit              (void);

_NEAR INT16U        OSVersion               (void);
...
#if OS_TASK_DEL_EN > 0u
_NEAR void          OS_Dummy                (void);
#endif

#if (OS_EVENT_EN)
_NEAR INT8U         OS_EventTaskRdy         (OS_EVENT        *pevent,
                                       void            *pmsg,
                                       INT8U            msk,
                                       INT8U            pend_stat);

_NEAR void          OS_EventTaskWait        (OS_EVENT        *pevent);

_NEAR void          OS_EventTaskRemove      (OS_TCB          *ptcb,
                                       OS_EVENT        *pevent);

#if (OS_EVENT_MULTI_EN > 0u)
_NEAR void          OS_EventTaskWaitMulti   (OS_EVENT       **pevents_wait);

_NEAR void          OS_EventTaskRemoveMulti (OS_TCB          *ptcb,
                                       OS_EVENT       **pevents_multi);
#endif

_NEAR void          OS_EventWaitListInit    (OS_EVENT        *pevent);
#endif

#if (OS_FLAG_EN > 0u) && (OS_MAX_FLAGS > 0u)
_NEAR void          OS_FlagInit             (void);
_NEAR void          OS_FlagUnlink           (OS_FLAG_NODE    *pnode);
#endif

_NEAR void          OS_MemClr               (INT8U           *pdest,
                                       INT16U           size);

_NEAR void          OS_MemCopy              (INT8U           *pdest,
                                       INT8U           *psrc,
                                       INT16U           size);

#if (OS_MEM_EN > 0u) && (OS_MAX_MEM_PART > 0u)
_NEAR void          OS_MemInit              (void);
#endif

#if OS_Q_EN > 0u
_NEAR void          OS_QInit                (void);
#endif

_NEAR void          OS_Sched                (void);

#if (OS_EVENT_NAME_EN > 0u) || (OS_FLAG_NAME_EN > 0u) || (OS_MEM_NAME_EN > 0u) || (OS_TASK_NAME_EN > 0u)
_NEAR INT8U         OS_StrLen               (INT8U           *psrc);
#endif

_NEAR void          OS_TaskIdle             (void            *p_arg);

_NEAR void          OS_TaskReturn           (void);

#if OS_TASK_STAT_EN > 0u
_NEAR void          OS_TaskStat             (void            *p_arg);
#endif

#if (OS_TASK_STAT_STK_CHK_EN > 0u) && (OS_TASK_CREATE_EXT_EN > 0u)
_NEAR void          OS_TaskStkClr           (OS_STK          *pbos,
                                       INT32U           size,
                                       INT16U           opt);
#endif

#if (OS_TASK_STAT_STK_CHK_EN > 0u) && (OS_TASK_CREATE_EXT_EN > 0u)
_NEAR void          OS_TaskStatStkChk       (void);
#endif

_NEAR INT8U         OS_TCBInit              (INT8U            prio,
                                       OS_STK          *ptos,
                                       OS_STK          *pbos,
                                       INT16U           id,
                                       INT32U           stk_size,
...
#if OS_DEBUG_EN > 0u
_NEAR void          OSDebugInit             (void);
#endif

_NEAR void          OSInitHookBegin         (void);
_NEAR void          OSInitHookEnd           (void);

_NEAR void          OSTaskCreateHook        (OS_TCB          *ptcb);
_NEAR void          OSTaskDelHook           (OS_TCB          *ptcb);

_NEAR void          OSTaskIdleHook          (void);

_NEAR void          OSTaskReturnHook        (OS_TCB          *ptcb);

_NEAR void          OSTaskStatHook          (void);
_NEAR OS_STK       *OSTaskStkInit           (void           (*task)(void *p_arg),
                                       void            *p_arg,
                                       OS_STK          *ptos,
                                       INT16U           opt);

#if OS_TASK_SW_HOOK_EN > 0u
_NEAR void          OSTaskSwHook            (void);
#endif

_NEAR void          OSTCBInitHook           (OS_TCB          *ptcb);

#if OS_TIME_TICK_HOOK_EN > 0u
_NEAR void          OSTimeTickHook          (void);
#endif
...
_NEAR void          App_TaskCreateHook      (OS_TCB          *ptcb);
_NEAR void          App_TaskDelHook         (OS_TCB          *ptcb);
_NEAR void          App_TaskIdleHook        (void);

_NEAR void          App_TaskReturnHook      (OS_TCB          *ptcb);

_NEAR void          App_TaskStatHook        (void);

#if OS_TASK_SW_HOOK_EN > 0u
_NEAR void          App_TaskSwHook          (void);
#endif

_NEAR void          App_TCBInitHook         (OS_TCB          *ptcb);

#if OS_TIME_TICK_HOOK_EN > 0u
_NEAR void          App_TimeTickHook        (void);
#endif
#endif
...
#if 0
_NEAR void          OSStartHighRdy          (void);
_NEAR void          OSIntCtxSw              (void);
_NEAR void          OSCtxSw                 (void);
#endif
