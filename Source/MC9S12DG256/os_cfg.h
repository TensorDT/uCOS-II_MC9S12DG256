...
//  File name:  os_cfg.h
//
//  Purpose:    uC/OS-II Configuration File for V2.8x
//
//  Target:     CPU 2.0
//
//  Revisions:
//   ##  dd mmm yyyy  who  description
//    1  28 Oct 2020  GPM  Initial revision based on Micrium V2.86
//
//  Notes:
//  LICENSING TERMS:
//  ---------------
...
//--------------------------- Included Files --------------------------
#include "mc9s12dg256_time.h"     // for TMR_CLK_FREQ_HZ
...
#define OS_MAX_TASKS              2    /* Max. number of tasks in your application, MUST be >= 2       */

#define OS_SCHED_LOCK_EN          1    /* Include code for OSSchedLock() and OSSchedUnlock()           */

#define OS_TICK_STEP_EN           1    /* Enable tick stepping feature for uC/OS-View                  */
#define OS_TICKS_PER_SEC   TMR_CLK_FREQ_HZ  /* Set the number of ticks in one second                   */
...
#define OS_TASK_NAME_EN           1    /* Enable task names (added 28-10-2020 due to ucos_ii.h error)  */
#define OS_TASK_REG_TBL_SIZE      0    /* Disable code for task-specific registers (added 28-10-2020)  */
...
#define OS_FLAG_NAME_EN           1    /* Enable flag names (added 28-10-2020 due to ucos_ii.h error)  */
...
#define OS_MEM_NAME_EN            1    /* Enable memory names (added 28-10-2020 due to ucos_ii.h error)*/
...
#define OS_TMR_CFG_NAME_EN        0    /* Disable timer names (28-10-2020)                             */
